        ...
        <div class="work__flipbox">
          <div class="work__flipbox-inner">
            ...
            <div class="work__flipbox-back">
              ...
              <Link to ="/candy-crush"><p className="work__link">Click for more Info</p></Link>
            </div>
          </div>
        </div>
        <div class="work__flipbox">
          <div class="work__flipbox-inner">
            ...
            <div class="work__flipbox-back">
              ...
              <Link to ="/punk"><p className="work__link">Click for more Info</p></Link>
            </div>
          </div>
        </div>
        <div class="work__flipbox">
          <div class="work__flipbox-inner">
            ...
            <div class="work__flipbox-back">
              ...
              <img className="work__flipbox--image" src={css} alt="" />
              <img className="work__flipbox--image" src={javascript} alt="" />
              <Link to ="/calculator"><p className="work__link">Click for more Info</p></Link>
            </div>
          </div>
        </div>
        <div class="work__flipbox">
          <div class="work__flipbox-inner">
            ...
            <div class="work__flipbox-back">
              ...
              <img className="work__flipbox--image" src={css} alt="" />
              <img className="work__flipbox--image" src={javascript} alt="" />
              <Link to ="/morse"><p className="work__link">Click for more Info</p></Link>
            </div>
          </div>
        </div>
        <div class="work__flipbox">
          <div class="work__flipbox-inner">
            ...
            <div class="work__flipbox-back">
              ...
              <img className="work__flipbox--image" src={css} alt="" />
              <img className="work__flipbox--image" src={javascript} alt="" />
              <Link to ="/noughts"><p className="work__link">Click for more Info</p></Link>
            </div>
          </div>
        </div>
